...
( function( $ ) {
	...
	wp.customize( 'blogname', function( value ) {
       ...
       wp.customize( 'nav_bg', function( value ) {
        ...
        value.bind( function( to ) {
            $( '.navicon:focus .fa-bars, .navicon:active .fa-bars, .navicon .fa-bars, .site-header .main-navigation ul li a, .site-header .main-navigation ul li a:hover, .site-header .main-navigation ul li a:visited, .site-header .main-navigation ul li a:focus, .site-header .main-navigation ul li a:active, .main-navigation ul li ul.childopen li:hover a, .main-navigation ul li ul.childopen li .active a, .navicon span' ).css( {
                'color':to
            });
        } );
    } );
        ...
        value.bind( function( to ) {
            $( '.blog time.entry-date.published, .post-main-category' ).css( {
                'color':to
            });
        } );
    } );
      wp.customize( 'blog_feed_post_text_color', function( value ) {
        ...
        value.bind( function( to ) {
            $( '.page #main time, .single-post #main time, .page time.entry-date.published, .single-post time.entry-date.published, .single-post .post-main-category' ).css( {
                'color':to
            });
        } );
    } );
       ...
       wp.customize( 'post_pages_button_text', function( value ) {
        ...
        value.bind( function( to ) {
            $( '.header-bottom-grid h3, .header-bottom-grid h3.widget-title' ).css( {
                'color':to
            });
        } );
    } );
        ...
        value.bind( function( to ) {
            $( '.header-bottom-grid p, .header-bottom-grid, .header-bottom-grid li, .header-bottom-grid ul' ).css( {
                'color':to
            });
        } );
    } );
        ...
        value.bind( function( to ) {
            $( '.header-bottom-grid a, .header-bottom-grid li a' ).css( {
                'color':to
            });
        } );
    } );
